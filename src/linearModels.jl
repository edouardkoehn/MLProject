...
begin
    mach_Log_Classifier_MLJ_PUY_L1=machine(self_Log_Classifier_MLJ_L1, select(train_PUY, Not(:precipitation_nextday)),train_PUY.precipitation_nextday)|> fit!
    report(mach_Log_Classifier_MLJ_PUY_L1).best_model
end
begin
...
begin
    mach_Log_Classifier_MLJ_PUY_L2=machine(self_Log_Classifier_MLJ_L2, select(train_PUY, Not(:precipitation_nextday)),train_PUY.precipitation_nextday)|> fit!
    report(mach_Log_Classifier_MLJ_PUY_L2).best_model
end
begin
...
begin
    ...
    report(mach_Log_Classifier_MLJ_Filled_L2)
end
begin
...
begin
    ...
    mach_Log_Classifier_MLJ_STD=machine(self_Log_Classifier_MLJ_L2, select(train_std, Not(:precipitation_nextday)),train_std.precipitation_nextday)|> fit!
    report(mach_Log_Classifier_MLJ_STD)
end
begin 
    exportMachine("mach_Log_Classifier_STD_MLJ_ALL_STD.jlso", mach_Log_Classifier_MLJ_STD)
end
